        ...
        <div className="min-h-screen flex flex-col lg:flex-row bg-background pt-20">
            ...
            <main className="flex-1 p-4 sm:p-6 lg:p-10 overflow-y-auto">
                <header className="mb-10">
                    <h1 className="font-display text-2xl sm:text-4xl lg:text-5xl tracking-tight text-white">
                        Categorii EuroShop
                    </h1>
                    <p className="mt-2 sm:mt-3 font-sans text-sm sm:text-base text-white/80 max-w-xl leading-relaxed">
